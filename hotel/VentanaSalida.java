...
/* Botón para calcular el valor a pagar y para registrar la salida del huésped */
    ...
    private int posiciónHabitación; /* Posición de la habitación en el vector de habitaciones */
...
// Localización de la etiqueta habitación en el layout (0,0) 
        c.gridx = 0;
        c.gridy = 0;
        contenedor.add(habitación);/* Se agrega la etiqueta habitación al contenedor de la ventana */
...
// Concatenamos la etiqueta con la fecha de ingreso obtenida 
...
/* Agrega al botón un ActionListener para que gestione eventos del botón */
    registrarSalida.addActionListener (
    this);
    }
    /*	Método que gestiona los eventos generados en la ventana de salida de huéspedes */
...
JOptionPane.showMessageDialog(this,"La fecha de salida es menor que la de ingreso","Mensaje", JOptionPane.ERROR_MESSAGE);
                            ...
                            "La fecha no está en el formato solicitado","Mensaje", JOptionPane.ERROR_MESSAGE);
}
            }
        }
    }
