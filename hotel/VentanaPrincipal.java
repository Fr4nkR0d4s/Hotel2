...
public class VentanaPrincipal extends JFrame implements ActionListener {
    ...
    private Container contenedor; // Un contenedor de elementos gráficos private 
    JMenuBar barraMenu; // Una barra de menú principal 
...
private void inicio() {
        ...
        menuOpciones.add(itemMenu1);/* Se agrega el ítem de menú al menú */
...
// Se ingresa el número de habitación 
                ...
                if (número < 1 || número > 10) {
                    ...
                    "El número de habitación debe estar entre 1 y 10","Mensaje",JOptionPane.INFORMATION_MESSAGE,null);
            ...
            VentanaSalida ventanaSalida = new VentanaSalida(hotel, número);
                    ...
                    JOptionPane.showMessageDialog(this,
                    "La habitación ingresada no ha sido ocupada","Mensaje", JOptionPane.INFORMATION_MESSAGE
             ,null);
}
